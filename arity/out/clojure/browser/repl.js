...
var script__$1 = (function (){var G__147 = script;
(G__147["type"] = "text/javascript");

(G__147["onload"] = onload);

(G__147["onreadystatechange"] = onload);

return G__147;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__148 = script__$1;
(G__148["src"] = src);

return G__148;
})():(function (){var G__149 = script__$1;
goog.dom.setTextContext(G__149,opt_sourceText);
...
var path_150 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_150];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_150)].join('')];
} else {
}
