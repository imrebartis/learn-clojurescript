...
var script__$1 = (function (){var G__618 = script;
(G__618["type"] = "text/javascript");

(G__618["onload"] = onload);

(G__618["onreadystatechange"] = onload);

return G__618;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__619 = script__$1;
(G__619["src"] = src);

return G__619;
})():(function (){var G__620 = script__$1;
goog.dom.setTextContext(G__620,opt_sourceText);
...
var path_621 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_621];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_621)].join('')];
} else {
}
