...
var script__$1 = (function (){var G__983 = script;
(G__983["type"] = "text/javascript");

(G__983["onload"] = onload);

(G__983["onreadystatechange"] = onload);

return G__983;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__984 = script__$1;
(G__984["src"] = src);

return G__984;
})():(function (){var G__985 = script__$1;
goog.dom.setTextContext(G__985,opt_sourceText);
...
var path_986 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_986];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_986)].join('')];
} else {
}
