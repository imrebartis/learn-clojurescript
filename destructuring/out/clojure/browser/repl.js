...
var script__$1 = (function (){var G__1000 = script;
(G__1000["type"] = "text/javascript");

(G__1000["onload"] = onload);

(G__1000["onreadystatechange"] = onload);

return G__1000;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__1001 = script__$1;
(G__1001["src"] = src);

return G__1001;
})():(function (){var G__1002 = script__$1;
goog.dom.setTextContext(G__1002,opt_sourceText);
...
var path_1003 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_1003];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_1003)].join('')];
} else {
}
