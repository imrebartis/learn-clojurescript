...
return (function (){
if(cljs.core.truth_((function (){var and__3949__auto__ = clojure.browser.repl.load_queue;
...
var script__$1 = (function (){var G__6264 = script;
(G__6264["type"] = "text/javascript");

(G__6264["onload"] = onload);

(G__6264["onreadystatechange"] = onload);

return G__6264;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__6265 = script__$1;
(G__6265["src"] = src);

return G__6265;
})():(function (){var G__6266 = script__$1;
goog.dom.setTextContext(G__6266,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__3957__auto__ = reload;
...
var path_6267 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_6267];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_6267)].join('')];
} else {
}
