...
var script__$1 = (function (){var G__124 = script;
(G__124["type"] = "text/javascript");

(G__124["onload"] = onload);

(G__124["onreadystatechange"] = onload);

return G__124;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__125 = script__$1;
(G__125["src"] = src);

return G__125;
})():(function (){var G__126 = script__$1;
goog.dom.setTextContext(G__126,opt_sourceText);
...
var path_127 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_127];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_127)].join('')];
} else {
}
