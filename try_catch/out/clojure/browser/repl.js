...
var script__$1 = (function (){var G__116 = script;
(G__116["type"] = "text/javascript");

(G__116["onload"] = onload);

(G__116["onreadystatechange"] = onload);

return G__116;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__117 = script__$1;
(G__117["src"] = src);

return G__117;
})():(function (){var G__118 = script__$1;
goog.dom.setTextContext(G__118,opt_sourceText);
...
var path_119 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_119];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_119)].join('')];
} else {
}
