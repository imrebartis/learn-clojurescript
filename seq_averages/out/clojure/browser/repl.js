...
var script__$1 = (function (){var G__980 = script;
(G__980["type"] = "text/javascript");

(G__980["onload"] = onload);

(G__980["onreadystatechange"] = onload);

return G__980;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__981 = script__$1;
(G__981["src"] = src);

return G__981;
})():(function (){var G__982 = script__$1;
goog.dom.setTextContext(G__982,opt_sourceText);
...
var path_983 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_983];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_983)].join('')];
} else {
}
